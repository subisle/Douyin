...
export const BATTLE_STAGE_TAB_OPTIONS: {
...
}[] = [
  {
    ...
    label: "小组赛分组",
    description:
      "内置 7 组 · 53 人均衡可打（8×4+7×3）；啸泽首组 / 啸帆末组 / 啸安第2组；08:15 起每组间隔 5 分钟",
  },
  {
    key: "promotion",
    label: "晋级赛分组",
