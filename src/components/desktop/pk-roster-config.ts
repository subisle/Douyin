...
/** v5：接龙 53 人（+狼征）均分 8×4+7×3；啸泽首/啸帆末/啸安异组·21:00 */
export const ROSTER_CONFIG_STORAGE_KEY = "pk-roster-list-config-v5";
/**
 * 15号 PK / 星嗨争霸赛默认白名单。
 * 来源：2026-07 接龙 + 狼征（洗后 53 人；阿楠→南方楠）。
 * 顺序与小组赛内置组一致（去峰日均从高到低 + 约束后 + 人数均分）。
 */
 ...
 * 规则：
 * - 按 2026-07 去峰日均从高到低填入均分容量
 * - 啸泽 → 第1组；啸帆 → 末组（首尾间隔）
 * - 啸泽 / 啸帆 / 啸安 三人（共同大姐）必须不同组
 * - 啸安尽量 21:00 场：第2组对准 21:00，则 20:45 起、间隔 15 分钟
 * - 狼征并入末段实力位
 * 出线：8人组前4晋级后4复活；7人组前4晋级后3复活（或按现场裁定）
 */
export const PRESET_BATTLE_GROUPS: string[][] = [
  // 第1组 · 8人 · 啸泽（首组）· 建议 20:45
  ["浩鸣", "啸辰", "狼澈", "浩冬", "南方楠", "玖玉", "浩雨", "啸泽"],
  // 第2组 · 8人 · 啸安（与泽/帆不同组 · 尽量 21:00）
  ...
  // 第5组 · 7人 · 建议 21:45
  ["啸森", "玖雪", "浩阳", "狼岳", "浩哲", "浩启", "狼艺"],
  // 第6组 · 7人 · 建议 22:00
  ["浩月", "浩杰", "狼哲", "浩泽", "啸阳", "啸强", "狼影"],
  // 第7组 · 7人 · 啸帆（末组）+ 狼征 · 建议 22:15
  ["啸帆", "狼途", "狼霆", "狼九", "狼旭", "狼征", "狼瑞"],
];
