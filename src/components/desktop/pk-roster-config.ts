...
/** v3：2026-07 接龙名单按去峰日均从高到低内置，避免沿用旧 localStorage */
export const ROSTER_CONFIG_STORAGE_KEY = "pk-roster-list-config-v3";
/**
 * 15号 PK / 星嗨争霸赛默认白名单。
 ...
 * 52人：8+8+8+8+8+8+4
 * 规则：按 2026-07 去峰日均音浪从高到低切块（每组最多 8 人）
 * 出线：8人组前4晋级后4复活；末组 4 人全部晋级或按现场裁定
 */
export const PRESET_BATTLE_GROUPS: string[][] = [
  // 第1组 · 最强
  ["浩鸣", "啸辰", "狼澈", "浩冬", "南方楠", "玖玉", "浩雨", "玖玥"],
  // 第2组
  ["狼俊", "玖柒", "狼小宝", "浩龙", "狼明", "狼兴", "玖妹", "啸安"],
  // 第3组
  ["狼仔", "狼辉", "狼轩", "啸泽", "狼辰", "狼泽", "啸帆", "狼腾"],
  // 第4组
  ["狼凯", "浩玟", "浩运", "浩辰", "啸宇", "狼博", "浩延", "狼佑"],
  // 第5组
  ["浩艺", "啸森", "玖雪", "浩阳", "狼岳", "浩哲", "浩启", "狼艺"],
  // 第6组
  ["浩月", "浩杰", "狼哲", "浩泽", "啸阳", "啸强", "狼影", "狼途"],
  // 第7组 · 末段
  ["狼霆", "狼九", "狼旭", "狼瑞"],
];
